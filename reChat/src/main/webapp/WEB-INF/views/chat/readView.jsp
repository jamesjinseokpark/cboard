...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".update_btn").on("click", function() {
			formObj.attr("action", "/chat/updateView");
	...
	<div id="root">
		...
		<section id="container">
			<form name="readForm" role="form" method="post">
				<input type="hidden" id="c_no" name="c_no" value="${read.c_no}" />
			</form>
			<table>
				<tbody>
					<tr>
						<td><label for="title">제목</label><input type="text"
							id="title" name="title" value="${read.c_title}" readonly="readonly" />
						</td>
					</tr>
					<tr>
						<td><label for="content">내용</label> <textarea id="content"
								name="content" readonly="readonly"><c:out
									value="${read.c_content}" /></textarea></td>
					</tr>
					<tr>
						<td><label for="writer">작성자</label><input type="text"
							id="writer" name="writer" value="${read.w_id}"
							readonly="readonly" /></td>
					</tr>
					<tr>
						<td><label for="regdate">작성날짜</label> <fmt:formatDate
								value="${read.c_date}" pattern="yyyy-MM-dd" /></td>
					</tr>
				</tbody>
			</table>
			<div>
